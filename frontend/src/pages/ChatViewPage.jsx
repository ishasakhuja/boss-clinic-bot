          ...
          messages.map((msg, index) => {
            ...
            return (
              ...
              >
                <div
                  style={{
                    backgroundColor: isUser ? "var(--color-white)" : "var(--color-green-200)",
                    borderColor: isUser ? "var(--color-gray-200)" : "var(--color-green-300)"
                  }}
                  className={`p-4 rounded-2xl border ${isUser ? "rounded-tl-none" : "rounded-tr-none text-left"}`}
                >
                  <p
                    className="text-[14px] whitespace-pre-wrap"
                    style={{ color: isUser ? "var(--color-gray-700)" : "var(--color-green-900)" }}
                  >
                ...
                <span
                  ...
                  style={{ color: "var(--secondary-text)" }}
                >
                  {isUser ? "User" : "AI Assistant"} • {msg.timestamp}
                </span>
              </div>
            );
          })
