...
export async function getTenantConfig(host = "byte.richgro.com.au") {
...
export async function getLeadProductDetails(leadId) {
  if (!leadId) throw new Error("leadId is required");

  const res = await fetchWithAuth(`${BASE_URL}/api/leads/${leadId}/product-stats`);
